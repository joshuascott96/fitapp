  ...
  return (
    <>
        <div name='faq' className='flex w-full py-8 bg-[#ffc8dd]'>
            <div className='content-faq flex flex-col justify-center'>
	                ...
	                <div className="flex flex-col justify-center text-[#d47699] px-4 pb-8 md:p-8">
		                <div className="space-y-4">
                            <details className="w-full group border-[#d47699] border-2 rounded-lg">
                                <summary className="p-6 text-sm sm:text-lg font-bold cursor-pointer list-none flex justify-between items-center">How are the programs delivered?<span className='ml-4'><FaPlus className='transition group-open:-rotate-45 duration-300'/></span></summary>
                            ...
                            <details className="w-full group border-[#d47699] border-2 rounded-lg" open="">
                                <summary className="p-6 text-sm sm:text-lg font-bold cursor-pointer list-none flex justify-between items-center">How often do the challenges start, can i start ASAP?<span className='ml-4'><FaPlus className='transition group-open:-rotate-45 duration-300'/></span></summary>
                            ...
                            <details className="w-full group border-[#d47699] border-2 rounded-lg">
                                <summary className="p-6 text-sm sm:text-lg font-bold cursor-pointer list-none flex justify-between items-center">Are the programs unique to me?<span className='ml-4'><FaPlus className='transition group-open:-rotate-45 duration-300'/></span></summary>
                            ...
                            <details className="w-full group border-[#d47699] border-2 rounded-lg" open="">
                                <summary className="p-6 text-sm sm:text-lg font-bold cursor-pointer list-none flex justify-between items-center">Are the programs updated at all once started?<span className='ml-4'><FaPlus className='transition group-open:-rotate-45 duration-300'/></span></summary>
                            ...
                            <details className="w-full group border-[#d47699] border-2 rounded-lg">
                                <summary className="p-6 text-sm sm:text-lg font-bold cursor-pointer list-none flex justify-between items-center">Do you provide nutrition guidance and meal plans?<span className='ml-4'><FaPlus className='transition group-open:-rotate-45 duration-300'/></span></summary>
