    ...
    <>
        <div name='challenge' className='flex w-full md:h-screen justify-center text-[#d47699] my-10 sm:my-0 bg-[#ffbed6]'>
            <div className='text-center md:grid md:grid-rows-4'>
                <div className='content my-auto py-14 md:py-0 row-span-1'>
                    <h2 className='font-extrabold text-4xl'>Challenges</h2>
                    <p className="text-sm pt-3">All packages are 100% tailored to each individual using the information provided in your coaching enquiry form.</p>
                </div>
                <div className='row-span-3'>
                    <div className='md:grid grid-cols-2 h-full'>
                        <div className='text-left p-14 bg-running scale bg-center bg-cover text-[#fff]'>
                            ...
                            <ul className='mt-6 space-y-2 border-l-4 border-[#ffffff75] pl-4 mb-12 sm:mb-0'>
